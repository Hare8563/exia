...
describe('SceneManager', () => {
  it('renders nothing when currentScene has no matching module', () => {
    useSceneStore.setState({ currentScene: 'nonexistent' as never, previousScene: null })
  ...
  it('renders nothing when modules prop is omitted and scene is unknown', () => {
    useSceneStore.setState({ currentScene: 'also-nonexistent' as never, previousScene: null })
